...
W = neu.fit(x_train, y_train, activations=activation_potentiation)

test_model = neu.evaluate(x_test, y_test, show_metrices=True, W=W, activations=activation_potentiation)
