...
# neu Modeli
model = nn.learn(x_train, y_train, genetic_optimizer, fit_start=True, show_history=True, auto_normalization=False, batch_size=0.05,
                     gen=20)
...
train_model = nn.evaluate(x_train, y_train, W=W, activation_potentiation=activation_potentiation)
train_acc_neu = train_model[model_ops.get_acc()]
...
test_acc_neu = test_model[model_ops.get_acc()]
