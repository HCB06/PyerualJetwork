from pyerualjetwork import ene, model_operations
import numpy as np
import cv2
...
genome_weights, genome_activations = ene.define_genomes(input_shape=7056, output_shape=2, population_size=100)
