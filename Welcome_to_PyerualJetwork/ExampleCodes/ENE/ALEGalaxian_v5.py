...
population_size = 50
genome_weights, genome_activations = ene_cuda.define_genomes(input_shape, output_shape, population_size, hidden=2, neurons=[256, 256], activation_functions=['tanh', 'tanh'])
