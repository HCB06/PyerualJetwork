...
def main():
    ...
    for generation in range(max_generation):
        ...
        model_ops.save_model(best_model, model_name=f'lunarlander_expert_gen{generation}', show_info=False)
    ...
    model = model_ops.load_model(model_name=f'lunarlander_expert_gen{max_generation - 1}', model_path='')
