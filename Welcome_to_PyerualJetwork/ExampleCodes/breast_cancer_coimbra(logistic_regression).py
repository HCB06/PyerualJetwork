...
y_val = data_ops.encode_one_hot(y_val, y_test)[0]
...
y_train = data_ops.decode_one_hot(y_train)
...
x_val = data_ops.standard_scaler(x_test=x_val, scaler_params=scaler_params)
