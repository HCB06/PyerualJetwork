...
model = nn.learn(x_train, y_train, gradient_optimizer=gradient_optimizer, fit_start=False, neurons=[64], activation_functions=['relu'], loss='categorical_corssentropy', backprop_train=True, iter=40, pop_size=0)
