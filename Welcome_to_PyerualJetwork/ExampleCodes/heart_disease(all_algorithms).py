...
x_train, x_test, y_train, y_test = data_operations.split(X, y, 0.2, 42) # For less data use this: (X, y, 0.9, 42)
...
model = neu.learn(x_train, y_train, genetic_optimizer, fit_start=True, gen=100)
