import numpy as np
from pyerualjetwork import model_operations, activation_functions
import pickle
...
while True:
    ...
    try:
        ...
        predict = model_operations.predict_from_memory(Input=inp, W=model[model_operations.get_weights()], activations=model[model_operations.get_act()], scaler_params=model[model_operations.get_scaler()])
