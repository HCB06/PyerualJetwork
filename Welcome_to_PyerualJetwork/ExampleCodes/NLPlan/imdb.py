from pyerualjetwork import memory_ops
...
scaler_params, x_train, x_test = data_ops_cpu.standard_scaler(x_train, x_test)
...
# Modeli kaydetme
model_ops.save_model(model_name='IMDB', scaler_params=scaler_params, W=W, activations=activation_potentiation)
