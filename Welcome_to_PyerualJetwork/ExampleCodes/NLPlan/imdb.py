from pyerualjetwork import neu_cuda, ene_cuda, data_operations, data_operations_cuda, model_operations, metrics_cuda, memory_operations
import pandas as pd
...
# Modeli kaydetme
model_operations.save_model(model_name='IMDB', scaler_params=scaler_params, W=W, activations=activation_potentiation)
