      ...
      # TRANSFORMATION PLAN TO MLP FOR PTNN (in later generations)
        ...
        if parallel_training:
            ...
            with Pool(processes=thread_count) as pool:
                ...
                if model_type == 'PLAN' and i == 0: act_pop = copy.deepcopy(activations)
                ...
                if start_this_W is not None and i == 0:
                    start_W = start_this_W
                else:
                    start_W = eval_params[0][4]
                
                if start_this_act is not None and i == 0:
                    start_act = start_this_act
                else:
                    start_act = eval_params[0][5]

                eval_params[0] = (
                    eval_params[0][0], eval_params[0][1], eval_params[0][2], eval_params[0][3],
                    start_W, start_act, eval_params[0][6], eval_params[0][7],
